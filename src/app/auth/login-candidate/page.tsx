  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (data.user.userType !== "CANDIDATE") {
        throw new Error("This login is for candidates only. Please use the company login.");
      }
  ...
  return (
    <div className="mx-auto max-w-md space-y-8 py-8">
      <div className="space-y-3 text-center">
        <p className="text-xs uppercase tracking-[0.4em] text-indigo-500">Candidate Portal</p>
        <h1 className="text-2xl font-semibold sm:text-3xl">Access your workspace</h1>
        <p className="text-sm text-zinc-500 sm:text-base">Login as a candidate to find job opportunities</p>
      </div>
